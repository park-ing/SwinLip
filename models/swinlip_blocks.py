...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 embed_dim=64, depths=[2, 2, 6], num_heads=(2, 4, 8),
    ...
    def forward_features(self, x, B, T):
        ...
        x,_ = self.CM_encoder(x, x.size(1))

        return x

    def forward(self, x, B, T):
        x = self.forward_features(x, B, T)
        return x
