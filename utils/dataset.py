...
import numpy as np
import sys
from .inference_utils import read_txt_lines
...
class MyDataset(object):
    ...
    def _get_boundary(self, filename, raw_data):
        ...
        boundary = np.zeros(n_frames) # non_speech duration
        boundary[left_idx:right_idx] = 1 # speech duration
        return boundary
